...
public class AdapterBusiness extends ArrayAdapter<Business> {
    ...
    public AdapterBusiness(@NonNull android.app.Activity context, @LayoutRes int resource, @NonNull List<Business> objects) {
    ...
    //show, share, waze, call, sms of business
    @NonNull
    @Override
            ...
            public void onClick(View v) {
                String text =
                        tvName.getText().toString() + "\n" +
                                tvDes.getText().toString() + "\n" + listBus.get(position).getBusinessMail() + "\n" + listBus.get(position).getBusinessPhone();
