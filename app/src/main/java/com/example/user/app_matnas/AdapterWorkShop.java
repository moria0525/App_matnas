...
/*
 * This Adapter of WorkShop
 */

public class AdapterWorkShop extends RecyclerView.Adapter<AdapterWorkShop.UserViewHolder> {

    private List<WorkShop> wsList;
    private Context context;


    public AdapterWorkShop(List<WorkShop> wsList, Context context) {
        this.wsList = wsList;
