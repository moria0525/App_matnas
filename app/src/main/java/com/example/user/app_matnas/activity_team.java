...
/*
 * This Activity represents an screen team of app
 * Allows to send mail to center team
 */
...
public class activity_team extends AppCompatActivity {
    ...
    public void getDataFromDB() {
        ...
        showProgressDialog();
        mDatabaseRef.child(DB_TEAM).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                hideProgressDialog();
                adapter = new AdapterTeam(activity_team.this, R.layout.activity_team, teamList);
    ...
    private void showProgressDialog() {
        if (mProgressDialog == null) {
            ...
            mProgressDialog.setMessage(getString(R.string.loadingTeam));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setQueryHint(getString(R.string.nameSearch));
