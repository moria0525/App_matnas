...
/*
 * This Adapter of project
 */

public class AdapterProject extends ArrayAdapter<Project> {

    private android.app.Activity context;
    private int resource;
    private List<Project> listProjects;

    public AdapterProject(@NonNull android.app.Activity context, @LayoutRes int resource, @NonNull List<Project> objects) {
