...
public class AdapterTeam extends ArrayAdapter<Team> {
    ...
    public AdapterTeam(@NonNull android.app.Activity context, @LayoutRes int resource, @NonNull List<Team> objects) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        mail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Intent.EXTRA_SUBJECT, context.getString(R.string.contact) + listTeam.get(position).getTeamName());
